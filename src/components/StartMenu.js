    ...
    <>
      {isOpen && (
        ...
        <div className="w-44">
          ...
          <hr className="my-0 border-win95-dark-gray" />
          
          <div className="px-2 py-0 win95-text-bold text-win95-dark-gray">
            Connect
          </div>
          
          <div 
            className="flex items-center px-2 py-0 win95-start-menu-item cursor-pointer"
