...
const Window = ({ 
  ...
  return (
    <div
      ref={windowRef}
      className={`absolute border border-gray-400 shadow-xl rounded-sm overflow-hidden ${isActive ? 'z-10' : 'z-0'}`}
      style={{
        ...windowStyle, 
    ...
    >
      {/* Modern Title Bar */}
      <div
        className="text-white px-3 py-1 flex justify-between items-center cursor-move select-none relative"
        style={{
      ...
      >
        ...
        <div className="window-controls flex gap-0 relative z-10">
          <button
      ...
      <div className={`${noPadding ? '' : 'p-2'} flex flex-col`} style={{ height: isMaximized ? `calc(100vh - ${taskbarHeight + 28}px)` : height - 28 }}>
