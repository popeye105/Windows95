  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex-1 bg-white border border-gray-400 mx-2 mb-2 mt-0 overflow-auto">
          <div className="divide-y divide-gray-200">
            {songs.map((song) => (
              <div
                ...
                style={currentSong?.id === song.id && isPlaying ? {
                  background: '#1d4ed8'
                } : {}}
        ...
        {currentSong && (
          <div className="flex-shrink-0 mx-2 mb-2 p-2 bg-white border border-gray-400">
            ...
            <div className="flex justify-center gap-1">
              <button onClick={() => playSong(currentSong)} className="modern-btn text-xs">
                {isPlaying ? '⏸️' : '▶️'}
              </button>
              <button onClick={stopSong} className="modern-btn text-xs">
                ⏹️
              </button>
            </div>
          </div>
