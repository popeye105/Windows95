        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
          ...
          <div className="flex gap-2 justify-center mt-2 flex-shrink-0">
            <button
              ...
              className="px-4 py-1 font-bold text-xs disabled:opacity-50 rounded-sm border border-gray-400 cursor-pointer transition-all duration-150"
              style={{
                background: 'linear-gradient(to bottom, #f0f0f0, #d8d8d8)',
                boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.6)'
              }}
              onMouseEnter={(e) => {
                if (!isSubmitting) e.target.style.background = 'linear-gradient(to bottom, #f8f8f8, #e0e0e0)';
              }}
              onMouseLeave={(e) => {
                if (!isSubmitting) e.target.style.background = 'linear-gradient(to bottom, #f0f0f0, #d8d8d8)';
              }}
            >
            ...
            <button
              type="button"
              onClick={handleClear}
              className="px-4 py-1 font-bold text-xs rounded-sm border border-gray-400 cursor-pointer transition-all duration-150"
              style={{
                background: 'linear-gradient(to bottom, #f0f0f0, #d8d8d8)',
                boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.6)'
              }}
